...
typeset -U PATH path
path=("/home/jayant/miniconda3/bin" "$path[@]")
export PATH
...
export ZSH="/home/jayant/.oh-my-zsh"
...
plugins=(git colored-man-pages vi-mode colorize extract history web-search autojump history-substring-search)
